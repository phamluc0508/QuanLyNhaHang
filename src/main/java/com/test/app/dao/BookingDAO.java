...
public class BookingDAO extends DAO {
    ...
    /**
     * Insert a new booking into the database, including its booked rooms. All are
        ...
        try {
            ...
            if (generatedKeys.next()) {
                ...
                for (BookedRoom br : b.getBookedRooms()) {
                    ...
                    ps.setDouble(6, br.getAmount());
                    ps.setBoolean(7, br.isCheckedIn());
    ...
    public ArrayList<Booking> getBookingOfRoom(int idroom, Date startDate, Date endDate) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                b.setTotalAmount(rs.getFloat("bookingsaleoff"));
                // client
                Client c = new Client();
                ...
                br.setAmount(rs.getFloat("roomsaleoff"));
